// OpcoesEditorLite.js — tema claro (praia)
// API: <OpcoesEditorLite value onChange editable />
// - Robusto contra cliques rápidos (guard global com cooldown curto)
// - Throttle no onChange (reduz bateladas de updates que tipicamente disparam rede)
// - UIDs estáveis por grupo/opção para evitar glitches de render ao adicionar/remover
// - Serialização canônica e anti-loop na propagação para o pai
// - Editável/desabilitado respeitado em todos os pontos
